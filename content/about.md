...
Сейчас занимаюсь внутренними процессами для разработчиков Техплатформы Городских сервисов. Обновляем процесс планирования, вводим скоринг проектов, делаем процессы прозрачными и удобными. Кроме этого — выстраиваю документирование и внутреннию поддержку. Применяем ИИ в работе с докой и поддержкой, анализе и проверке гипотез. 
...
Занимала роль ведущего менеджера проектов — отвечала не за конкретную команду разработки, а в целом за процессы проектного офиса. Запустила переход с полугодового на квартальное планирование; помогла команде поддержки внедрить ИИ в свою работу (отчёты, ответы, инструкции); наняла и наладила работу техписателей с разработкой Техплатформы. 
